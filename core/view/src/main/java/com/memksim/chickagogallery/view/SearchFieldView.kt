package com.memksim.chickagogallery.view
...
import com.memksim.chickagogallery.view.databinding.SearchFieldViewBinding
...
class SearchFieldView(
    ...
    private fun initAttrs(
        ...
        with(binding) {
            ...
            hint.hint = text ?: context.getString(R.string.find_art)
